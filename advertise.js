 ...
 * 3. Access the chatbot from other devices using: http://chatbot.local:3001
 */
...
const service = {
  ...
  host: 'chatbot.local', // The hostname to advertise
  type: 'http',        // Service type
  port: 3001,          // The port your chatbot runs on
